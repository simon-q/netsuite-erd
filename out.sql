...
CREATE TABLE Group_test_cell (
    ...
    test_cell_id NUMERIC(39, 0),
    PRIMARY KEY (crm_group_id, test_cell_id)
);
...
ALTER TABLE Expense_plans ADD CONSTRAINT expense_plans_transaction_lines_fk FOREIGN KEY (transaction_doc_id) REFERENCES Transaction_lines (transaction_id);
ALTER TABLE Expense_plans ADD CONSTRAINT expense_plans_transaction_lines_fk_1 FOREIGN KEY (transaction_line_id) REFERENCES Transaction_lines (transaction_line_id);
